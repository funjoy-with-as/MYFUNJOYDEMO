...
public class RecylePage extends AppCompatActivity
{
...
//        snapHelper.attachToRecyclerView(mRecyclerView);
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder>//适配器，必须继承RecyclerView.Adapter
    {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(RecylePage.this).inflate(R.layout.mycycleitem, parent,
                    false));
            return holder;
        }
